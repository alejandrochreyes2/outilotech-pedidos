...
export const routes: Routes = [
  ...
  { path: 'facturacion/imprimir/:id', loadComponent: () => import('./components/imprimir-factura/imprimir-factura.component').then(m => m.ImprimirFacturaComponent), canActivate: [authGuard] },
  { path: 'scanner/:token', loadComponent: () => import('./components/mobile-scanner/mobile-scanner.component').then(m => m.MobileScannerComponent) },
  ...
  { path: 'portafolio1', loadComponent: () => import('./components/portafolio-gerente/portafolio-gerente.component').then(m => m.PortafolioGerenteComponent) },
  { path: '**',        redirectTo: '/' }
];
